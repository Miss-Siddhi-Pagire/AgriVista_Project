            ...
            <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                ...
                <div className="text-center mb-5 planner-header">
                    ...
                    <p className="lead text-muted">
                        <span>Get a comprehensive farming strategy tailored to your location.</span>
                    </p>
                </div>
                    ...
                    {plan && (
                        <div>
                            ...
                            <div style={{ marginTop: '30px', borderTop: '1px solid #eee', paddingTop: '15px', textAlign: 'center', fontSize: '10px', color: '#999' }}>
                                <p><span>Generated by AgriVista. Consult local experts before major investment.</span></p>
                            </div>
                        </div>
                    )}
                </div>
